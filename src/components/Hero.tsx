          ...
          {Array.from({ length: 144 }).map((_, i) => (
            <div
              ...
              className={`
                ...
                ${i % 7 === 0 ? 'bg-blue-200/20' : ''}
                ${i % 11 === 0 ? 'bg-purple-200/20' : ''}
                ${i % 13 === 0 ? 'bg-indigo-200/20' : ''}
                ${i % 17 === 0 ? 'bg-pink-200/20' : ''}
              `}
            />
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Join millions of learners worldwide. Access thousands of courses, earn certificates, 
              and advance your career with our comprehensive learning management system.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 text-lg font-semibold transition-all duration-300 transform hover:scale-105">
                Start Learning Today
              </Button>
              <Button variant="outline" size="lg" className="border-2 border-gray-300 hover:border-blue-500 px-8 py-3 text-lg font-semibold transition-all duration-300">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900">Advanced React Course</h3>
